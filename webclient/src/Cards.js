...
export function Cards(props) {
	...
	const cardStatus = (c) =>
		c.active_status === 'card_active' ? 'Yes' : 'No';
	...
	return (
		<Container>
			...
			{user.member.card_photo ? (
				<p>
					<a
						href={staticUrl + '/' + user.member.card_photo}
						target="_blank"
					>
						Click here
					</a>{' '}
			...
			{open ? (
				<React.Fragment>
					...
					<p>
						...
						<br />
						<a
							href="https://docs.my.protospace.ca/api.html"
							target="_blank"
							rel="noopener noreferrer"
							aria-label="link to our API docs"
						>
					...
					<p>
						<code>
							...
							https://api.my.protospace.ca/user/
						</code>
					</p>
					...
					<code>
						...
						{'}'}
						<br />
						r = requests.get('https://api.my.protospace.ca/user/',
						headers=headers)
						<br />
						<br />
				...
				<p>
					<Button onClick={() => setOpen(true)}>Show Secret</Button>
				</p>
			)}
		</Container>
	);
