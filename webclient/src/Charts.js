	...
	return (
		<Container>
			...
			{memberCount && signupCount && (
				<>
					<p>
						The total member count is{' '}
						{memberCount.slice().reverse()[0].member_count} members,
						compared to{' '}
						{memberCount.slice().reverse()[30].member_count} members
						30 days ago.
					</p>
					<p>
						The green member count is{' '}
						{memberCount.slice().reverse()[0].green_count} members,
						compared to{' '}
						{memberCount.slice().reverse()[30].green_count} members
						30 days ago.
					</p>
					<p>
						The older than six months member count is{' '}
						{memberCount.slice().reverse()[0].six_month_plus_count}{' '}
						members, compared to{' '}
						{memberCount.slice().reverse()[30].six_month_plus_count}{' '}
						members 30 days ago.
					</p>
					<p>
						The vetted member count is{' '}
						{memberCount.slice().reverse()[0].vetted_count} members,
						compared to{' '}
						{memberCount.slice().reverse()[30].vetted_count} members
						30 days ago.
					</p>
					<p>
						There were{' '}
						{signupCount.slice().reverse()[0].signup_count} signups
						so far this month, and{' '}
						{signupCount.slice().reverse()[1].signup_count} signups
						last month.
					</p>
				</>
			)}
			...
			{fullActivity ? (
				...
				<p>
					...
					<Button size="tiny" onClick={() => setFullActivity(true)}>
						View All
					</Button>
				</p>
			)}
			...
			<p>
				Cards Scans: number of individual members who have scanned to
				enter the space.
			</p>
			...
			<p>
				Signup Count: number of brand new account registrations that
				month.
			</p>

			<p>
				Later Vetted Count: number of those signups who eventually got
				vetted (at a later date).
			</p>

			<p>
				Retained Count: number of those signups who are still a member
				currently.
			</p>
		</Container>
	);
