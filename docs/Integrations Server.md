...
Private details, including how to recover access, are described [here](https://github.com/Protospace/infrastructure/blob/main/on-premises/integrations-server.md).
